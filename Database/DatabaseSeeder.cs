    ...
    TransformerRepository transformerRepository)
{
    public async Task SeedAsync()
    {
        ...
        await sensorRepository.AddAsync(new Sensor(modbusDeviceVfd, "Frequency", 1, new IoDirection(IoDirectionType.Input), "Hz", 2), modbusDeviceVfd.Id);
        await sensorRepository.AddAsync(new Sensor(modbusDeviceVfd, "Power Usage", 5, new IoDirection(IoDirectionType.Input), "Kw", 1), modbusDeviceVfd.Id);
